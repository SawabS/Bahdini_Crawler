...
| OCR scanned PDFs into the Bahdini corpus (Gemini pipeline, A–Z) | [docs/DOCUMENT_AI_OCR_GUIDE.md](docs/DOCUMENT_AI_OCR_GUIDE.md) |
| Synchronize an older local checkout after a pull | [docs/POST_PULL_SYNC_AGENT_PROMPT.md](docs/POST_PULL_SYNC_AGENT_PROMPT.md) |
